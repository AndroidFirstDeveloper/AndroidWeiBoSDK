...
/*     */   public int duration;
/*     */   
/*  53 */   public static final Parcelable.Creator<MusicObject> CREATOR = new Parcelable.Creator<MusicObject>()
/*     */     {
/*  55 */       public MusicObject createFromParcel(Parcel in) { return new MusicObject(in); }
/*     */ 
/*     */ 
/*     */       
/*  59 */       public MusicObject[] newArray(int size) { return new MusicObject[size]; }
/*     */     };
/*     */ 
/*     */   
/*     */   public MusicObject() {}
...
/*  89 */       LogUtil.e("Weibo.MusicObject", "checkArgs fail, dataUrl is invalid");
/*  90 */       return false;
/*     */     } 
/*  92 */     if (this.dataHdUrl != null && this.dataHdUrl.length() > 512) {
/*  93 */       LogUtil.e("Weibo.MusicObject", "checkArgs fail, dataHdUrl is invalid");
/*  94 */       return false;
/*     */     } 
/*  96 */     if (this.duration <= 0) {
/*  97 */       LogUtil.e("Weibo.MusicObject", "checkArgs fail, duration is invalid");
/*  98 */       return false;
/*     */     } 
/* 100 */     return true;
/*     */   }
...
/*     */ 
/*     */   
/* 105 */   public int getObjType() { return 3; }
/*     */ 
/*     */ 
/*     */   
...
/* Location:              C:\Users\Administrator\Desktop\weibosdkcore.jar!\com\sina\weibo\sdk\api\MusicObject.class
